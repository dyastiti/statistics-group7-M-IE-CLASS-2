...
# =========================
TEAM_MEMBERS = [
    {"name": "Dyastiti Eka Marlinda", "sid": "004202400047", "role": "Front-End", "image": "dyas.jpg"},
    {"name": "Lovyta Amelia", "sid": "004202400108", "role": "Data Processing", "image": "amel.jpg"},
    {"name": "Mutiara Rahemi Putri", "sid": "004202400131", "role": "Reporting", "image": "muti.jpg"},
...
def compute_pearson(df, x, y):
    ...
    return stats.pearsonr(valid[x], valid[y])
